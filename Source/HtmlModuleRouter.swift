...
public class HtmlModuleRouter: BaseRouter<HtmlModuleRoute> {
    ...
    public override func prepareTransition(for route: HtmlModuleRoute) -> RouteTransition {
        return RouteTransition(module: HtmlController(type: module?.config?.type, data: module?.data), isRoot: false, isAnimated: true, showNavigationBar: true, showTabBar: false)
    }
...
struct IFrameModel: Codable, XMLMappable {
